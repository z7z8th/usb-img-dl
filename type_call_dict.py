...
def update_type_call_dict():
    ...
    type_call_dict = {
        ...
        IMG_USER_DATA : {'std_name':'userdata',      'name_pattern':r'udata|userdata',
        ...
        IMG_M_DATA : {'std_name':'machine-data',  'name_pattern':r'mdata|macine-data',
        ...
        IMG_BAREBOX_ENV : {'std_name':'barebox-data',  'name_pattern':r'barebox-data',
                'img_type':'dyn_id', 'func_params':ID_BAREBOX_ENV},

        IMG_LDR_APP : {'std_name':'ram-loader', 'name_pattern':r'ram_ldr|ldr_app|ram_loader',
