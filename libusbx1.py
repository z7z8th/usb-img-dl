...
_logger = logging.getLogger('usb.backend.libusbx1')
...
def _load_library():
    if sys.platform != 'cygwin':
        candidates = ('usbx-1.0', 'libusbx-1.0', 'usbx')
    ...
    print "<><> got lib: ", libname
    #libname = "libusbx-1.0.so.0"
...
def get_backend():
    ...
    try:
        ...
        _logger.error('Error loading libusbx 1.0 backend', exc_info=True)
        return None
